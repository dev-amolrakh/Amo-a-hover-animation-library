    ...
    each(
      ...
      function (el) {
        el.addEventListener("pointermove", function (ev) {
          ...
          el.style.setProperty("--mx", (x - 0.5) * 10 + "px");
          el.style.setProperty("--my", (y - 0.5) * 8 + "px");
          el.style.setProperty("--mry", (x - 0.5) * 16 + "deg");
          el.style.setProperty("--mrx", (0.5 - y) * 16 + "deg");
        });
        el.addEventListener("pointerleave", function () {
          ["--mx", "--my", "--mrx", "--mry"].forEach(function (k) {
      ...
      function (el) {
        ...
        el.addEventListener("pointerenter", function () {
          ...
          el._amoTimer = setInterval(function () {
            ...
            out.textContent = Array.from(word)
              .map(function (c, i) {
                return c === " " || i < done
                  ? c
